...
@RestController
@RequestMapping("/archiveInfo/contact")
@Api(value = "/archiveInfo/contact", tags = {"存档资料-来往公文"})
public class ContactPaperController {

    @Autowired
    private ContactPaperService archiveInfoService;

    @PostMapping("/search")
    @RequiresPermissions("archiveInfo:contact:search")
    ...
    @RequiresPermissions(value = "archiveInfo:contact:delete")
    ...
    @RequiresPermissions(value = "archiveInfo:contact:download")
    ...
    public Result<List<ArchiveInfoTypeResponse>> findAllType(){
        return archiveInfoService.findAllType("来往公文");
    }
