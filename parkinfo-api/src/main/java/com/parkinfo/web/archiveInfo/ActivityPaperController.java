...
@Api(value = "/archiveInfo/activity", tags = {"存档资料-活动类材料"})
public class ActivityPaperController {

    @Autowired
    private ActivityPaperService archiveInfoService;

    @PostMapping("/search")
    @RequiresPermissions("archiveInfo:activity:search")
    ...
    @RequiresPermissions(value = "archiveInfo:activity:delete")
    ...
    @RequiresPermissions(value = "archiveInfo:activity:download")
