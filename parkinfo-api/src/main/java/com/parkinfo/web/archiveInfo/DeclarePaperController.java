...
public class DeclarePaperController {
    ...
    @RequiresPermissions(value = "archiveInfo:declare:delete")
    ...
    @PostMapping("/add")
    @RequiresPermissions(value = "archiveInfo:declare:add")
    ...
    @PostMapping("/edit/{id}")
    @RequiresPermissions(value = "archiveInfo:declare:edit")
    ...
    @RequiresPermissions(value = "archiveInfo:declare:download")
    ...
    public Result<List<ArchiveInfoTypeResponse>> findAllType(){
        return archiveInfoService.findAllType("申报材料");
    }
