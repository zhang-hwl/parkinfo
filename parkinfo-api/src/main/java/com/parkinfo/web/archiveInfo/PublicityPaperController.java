...
import com.parkinfo.service.archiveInfo.impl.ContactPaperService;
import com.parkinfo.service.archiveInfo.impl.PublicityPaperService;
...
@RestController
@RequestMapping("/archiveInfo/publicity")
@Api(value = "/archiveInfo/publicity", tags = {"存档资料-宣传类材料"})
public class PublicityPaperController {

    @Autowired
    private PublicityPaperService archiveInfoService;

    @PostMapping("/search")
    @RequiresPermissions("archiveInfo:publicity:search")
    ...
    @RequiresPermissions(value = "archiveInfo:publicity:delete")
    ...
    @RequiresPermissions(value = "archiveInfo:publicity:download")
    ...
    public Result<List<ArchiveInfoTypeResponse>> findAllType(){
        return archiveInfoService.findAllType("宣传类材料");
    }
