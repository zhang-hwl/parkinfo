...
@Api(value = "/archiveInfo/enter", tags = {"存档资料-入驻企业资料"})
public class EnterPaperController {

    @Autowired
    private EnterPaperService archiveInfoService;

    @PostMapping("/search")
    @RequiresPermissions("archiveInfo:enter:search")
    ...
    @RequiresPermissions(value = "archiveInfo:enter:delete")
    ...
    @RequiresPermissions(value = "archiveInfo:enter:download")
