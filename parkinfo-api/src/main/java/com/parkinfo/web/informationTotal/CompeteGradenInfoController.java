...
public class CompeteGradenInfoController {
    ...
    public Result<String> addCompeteGradenInfo(@RequestBody CompeteGradenInfo competeGradenInfo){
        return competeGradenInfoService.addCompeteGradenInfo(competeGradenInfo);
    }

    @PostMapping("/edit")
    @ApiOperation(value = "编辑竞争园区信息")
    public Result<String> editCompeteGradenInfo(@RequestBody CompeteGradenInfo competeGradenInfo){
        return competeGradenInfoService.editCompeteGradenInfo(competeGradenInfo);
    }
